...
namespace PDFArchiveApp.Views
{
    public sealed partial class ShellPage : Page, INotifyPropertyChanged
    {
        ...
        private void PopulateNavItems()
        {
            ...
            _primaryItems.Add(ShellNavigationItem.FromType<MainPage>("Shell_Main".GetLocalized(), Symbol.Page));
            //_primaryItems.Add(ShellNavigationItem.FromType<AppPage>("Shell_App".GetLocalized(), Symbol.Document));
            _primaryItems.Add(ShellNavigationItem.FromType<ArchiveListPage>("Shell_ArchiveList".GetLocalized(), Symbol.Read));
